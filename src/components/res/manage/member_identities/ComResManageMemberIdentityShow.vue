...
const ComResManageMemberIdentityShow = defineComponent({
  name: 'ComResManageMemberIdentityShow',
  components: {},
  props: {
...
export default ComResManageMemberIdentityShow;
</script>

<template lang="pug">
.com-res-manage-member-identity-show
  TaShowLayout(
    :tabs='tabs',
    :title='record.name',
    :store='store',
